...
header('Content-Disposition: attachment;filename= STReport.csv');
...
$columnHeaders = array("Barcode", "Orginal Qty", "Scanned Qty", "Status"); // Replace with your actual column names
